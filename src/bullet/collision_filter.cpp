...
struct CollisionFilter::Implementation {
    ...
    std::set<std::pair<EntityId, EntityId>> m_collisions;
...
CollisionFilter::getFilterSignature() const {
    return std::pair(m_impl->m_collisionGroup1, m_impl->m_collisionGroup2);
}
